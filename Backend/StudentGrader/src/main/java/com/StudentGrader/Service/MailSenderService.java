...
public class MailSenderService {
    ...
    private void sendHtmlEmail(String toEmail, String subject, String htmlBody) throws MessagingException {
        ...
        helper.setFrom("virajdimble6@gmail.com");
    ...
    private String buildWelcomeEmailHtml(String studentName) {
        return "<html>" +
                ...
                "      Developed by <a href=\"mailto:virajdimble6@gmail.com\" style=\"color:#2E86C1; text-decoration:none;\">virajdimble6@gmail.com</a>"
                +
                "    </p>" +
                "  </div>" +
                "</body>" +
    ...
    private String buildQuizCompletionEmailHtml(String studentName, int finalScore) {
        return "<html>" +
                ...
                "    <hr style=\"border:none; border-top:1px solid #eee; margin: 30px 0;\"/>" +
                "    <p style=\"font-size: 0.85em; color: #666; text-align: center;\">" +
                "      Developed by <a href=\"mailto:virajdimble6@gmail.com\" style=\"color:#27AE60; text-decoration:none;\">virajdimble6@gmail.com</a>"
                +
                "    </p>" +
                "  </div>" +
                "</body>" +
...
//
// // Send quiz completion email with final score (HTML)
// public void sendQuizCompletionEmail(String toEmail, String studentName, int
// finalScore) {
// String subject = "Quiz Completed! Your Final Score";
// String body = buildQuizCompletionEmailHtml(studentName, finalScore);
// sendHtmlEmail(toEmail, subject, body);
...
// "<h2 style='color:#2E86C1;'>Welcome to StudentGrader, " + studentName +
// "!</h2>" +
// "<p>Thank you for signing up at <strong>StudentGrader</strong>. We're excited
// to have you onboard.</p>" +
// "<p>Get ready to challenge yourself and improve your skills!</p>" +
// "<hr style='border:none; border-top:1px solid #eee;'/>" +
// "<p style='font-size:0.9em; color:#666;'>Developed by <a
// href='mailto:maheshgavale087@gmail.com'>maheshgavale087@gmail.com</a></p>" +
// "</body>" +
// "</html>";
// }
//
// // Build HTML for quiz completion email
// private String buildQuizCompletionEmailHtml(String studentName, int
// finalScore) {
// return "<html>" +
// "<body style='font-family:Arial,sans-serif; color:#333;'>" +
// "<h2 style='color:#27AE60;'>Congratulations, " + studentName + "!</h2>" +
// "<p>You have successfully completed the quiz.</p>" +
// "<p>Your final score is: <strong style='font-size:1.5em; color:#E67E22;'>" +
// finalScore + "</strong></p>" +
